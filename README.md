...
- Для `Running` є одна fixed-dispatch точка: adapter доставляє tick у [`scripts/диспетчер.мій`](scripts/%D0%B4%D0%B8%D1%81%D0%BF%D0%B5%D1%82%D1%87%D0%B5%D1%80.%D0%BC%D1%96%D0%B9). Сценарій сам запитує факти й викликає capabilities; C++ не розбирає його `t`/`()` і не тримає сценарний стан.
...
Canonical Ukrainian oracle: [`scripts/перший-зріз.мій`](scripts/%D0%BF%D0%B5%D1%80%D1%88%D0%B8%D0%B9-%D0%B7%D1%80%D1%96%D0%B7.%D0%BC%D1%96%D0%B9).
